...
const testimonials = [
  {
    quote:
      'Раньше я узнавала о просроченных обращениях от самих клиентов — уже с претензией. Теперь вижу всё в реальном времени и успеваю вмешаться до конфликта. За 3 месяца ни одной жалобы на скорость.',
  ...
  {
    quote:
      "У нас 4 бухгалтера и 80+ клиентов. Было невозможно отследить, кто кому ответил. BuhBot показал, что 15% обращений 'терялись'. Сейчас потерь ноль, а среднее время ответа упало с 6 часов до 1.5.",
  ...
  {
    quote:
      'Внедрили за день, без обучения сотрудников — всё работает в привычном Telegram. Бухгалтеры даже не заметили изменений, а я наконец-то получил нормальную аналитику по нагрузке.',
          ...
          {testimonials.map((item, index) => (
            <motion.div
              ...
              whileHover={{
                scale: 1.02,
                boxShadow:
                  '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04), 0 0 40px -10px var(--buh-accent-glow)',
              }}
