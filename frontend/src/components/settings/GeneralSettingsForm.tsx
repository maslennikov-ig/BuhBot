    ...
    <div className="space-y-6">
        ...
        <div className="mb-6 rounded-lg border border-[var(--buh-warning)] bg-[var(--buh-warning)]/10 p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--buh-foreground-muted)] mt-1">
              При нарушении SLA уведомления не будут доставлены. Добавьте Telegram ID менеджеров в
              настройках чатов или глобальных настройках.
            </p>
          </div>
        </div>
      )}
      <GlassCard variant="default" padding="lg" className="buh-hover-lift">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-[var(--buh-foreground)]">Telegram Bot</h2>
            <p className="text-sm text-[var(--buh-foreground-muted)]">Connection configuration</p>
          </div>
        </div>
