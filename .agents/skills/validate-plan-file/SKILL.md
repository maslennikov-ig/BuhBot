...
- `.bug-*-plan.json` → `.Codex/schemas/bug-plan.schema.json`
- `.security-*-plan.json` → `.Codex/schemas/security-plan.schema.json`
- `.dead-code-*-plan.json` → `.Codex/schemas/dead-code-plan.schema.json`
- `.dependency-*-plan.json` → `.Codex/schemas/dependency-plan.schema.json`
...
Use Read tool to load the appropriate schema file from `.Codex/schemas/`.
...
```json
{
  ...
  "warnings": [],
  "schema": "bug-plan",
  "schemaPath": ".Codex/schemas/bug-plan.schema.json"
}
```
...
```json
{
  ...
  "schemaPath": ".Codex/schemas/security-plan.schema.json"
}
```
...
```json
{
  ...
  "schemaPath": ".Codex/schemas/dependency-plan.schema.json"
}
```
